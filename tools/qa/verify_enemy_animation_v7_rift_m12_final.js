/* Verify the promoted RIFT_M12 V7 GPU final asset. */
"use strict";
...
const manifestPath = path.join(root, "assets", "enemies", "production_pilot_v7", "RIFT_M12", "RIFT_M12_PRODUCTION_PILOT_V7_GPU_FINAL_MANIFEST.json");
...
assert.equal(manifest.id, "RIFT_M12");
...
assert.ok(override.includes("productionRevision:'RIFT_M12_V7_GPU_FINAL'"));
assert.ok(override.includes("assets/enemies/production_pilot_v7/RIFT_M12/RIFT_M12_PRODUCTION_PILOT_V7_GPU_FINAL.webp"));
