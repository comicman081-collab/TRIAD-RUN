/* Verify the promoted RIFT_M09 V7 GPU final asset. */
"use strict";
...
const manifestPath = path.join(
  ...
  "production_pilot_v7",
  "RIFT_M09",
  "RIFT_M09_PRODUCTION_PILOT_V7_GPU_FINAL_MANIFEST.json",
);
...
assert.equal(manifest.id, "RIFT_M09");
...
assert.ok(override.includes("productionRevision:'RIFT_M09_V7_GPU_FINAL'"));
assert.ok(
  override.includes(
    "assets/enemies/production_pilot_v7/RIFT_M09/RIFT_M09_PRODUCTION_PILOT_V7_GPU_FINAL.webp",
  ),
);
