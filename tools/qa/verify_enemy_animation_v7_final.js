/* Verify the promoted RIFT_M10 V7 GPU final asset. */
"use strict";
...
const manifestPath = path.join(root, "assets", "enemies", "production_pilot_v7", "RIFT_M10", "RIFT_M10_PRODUCTION_PILOT_V7_GPU_FINAL_MANIFEST.json");
...
assert.equal(manifest.id, "RIFT_M10");
...
assert.ok(override.includes("productionRevision:'RIFT_M10_V7_GPU_FINAL'"));
assert.ok(override.includes("assets/enemies/production_pilot_v7/RIFT_M10/RIFT_M10_PRODUCTION_PILOT_V7_GPU_FINAL.webp"));
