/* Verify the promoted RIFT_M11 V7 GPU final asset. */
"use strict";
...
const manifestPath = path.join(root, "assets", "enemies", "production_pilot_v7", "RIFT_M11", "RIFT_M11_PRODUCTION_PILOT_V7_GPU_FINAL_MANIFEST.json");
...
assert.equal(manifest.id, "RIFT_M11");
...
assert.ok(override.includes("productionRevision:'RIFT_M11_V7_GPU_FINAL'"));
assert.ok(override.includes("assets/enemies/production_pilot_v7/RIFT_M11/RIFT_M11_PRODUCTION_PILOT_V7_GPU_FINAL.webp"));
