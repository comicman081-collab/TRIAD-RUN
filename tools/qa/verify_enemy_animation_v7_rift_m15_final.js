/* Verify the promoted RIFT_M15 V7 GPU final asset. */
"use strict";
...
const manifestPath = path.join(root, "assets", "enemies", "production_pilot_v7", "RIFT_M15", "RIFT_M15_PRODUCTION_PILOT_V7_GPU_FINAL_MANIFEST.json");
...
assert.equal(manifest.id, "RIFT_M15");
...
assert.ok(override.includes("productionRevision:'RIFT_M15_V7_GPU_FINAL'"));
assert.ok(override.includes("assets/enemies/production_pilot_v7/RIFT_M15/RIFT_M15_PRODUCTION_PILOT_V7_GPU_FINAL.webp"));
