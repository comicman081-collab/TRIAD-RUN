...
vm.runInNewContext(fs.readFileSync(path.join(root,'combat_vfx_skill_assets_v5.js'),'utf8'),sandbox,{filename:'combat_vfx_skill_assets_v5.js'});
...
const assertions=[
  ...
  ['enemy projectile carries an impact follow-up',scout.asset.motion==='TRAVEL'&&scout.impactAsset.path===sandbox.window.TRIAD_COMBAT_VFX_SKILL_ASSETS_V5.enemies.VOLT_SCOUT_JAB.impact],
