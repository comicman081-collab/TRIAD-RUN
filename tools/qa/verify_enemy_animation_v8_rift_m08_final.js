/* Verify the promoted RIFT_M08 V8 GPU final asset. */
"use strict";
...
const manifestPath = path.join(
  ...
  "production_pilot_v8",
  "RIFT_M08",
  "RIFT_M08_PRODUCTION_PILOT_V8_GPU_FINAL_MANIFEST.json",
);
...
assert.equal(manifest.schema, "triad.enemy-production-pilot.v8");
assert.equal(manifest.id, "RIFT_M08");
...
assert.ok(override.includes("productionRevision:'RIFT_M08_V8_GPU_FINAL'"));
assert.ok(
  override.includes(
    "assets/enemies/production_pilot_v8/RIFT_M08/RIFT_M08_PRODUCTION_PILOT_V8_GPU_FINAL.webp",
  ),
);
