...
window.TRIAD_SD_MANIFESTS['TRIAD-CHAR-011'] = {
  schema:'triad.sd.bundle.v1',status:'PASS_ACTIVE_FINAL',characterId:'TRIAD-CHAR-011',revision:1,
  ...
  ].map(([clip,loop,events])=>[clip,{atlas:`assets/characters/roster/TRIAD-CHAR-011/sd/revisions/r001_authority_texture_atlases/sena_${clip}_r001_84f.webp`,frames:84,fps:30,columns:12,rows:7,loop,holdLastFrame:['ko','victory'].includes(clip),events,motion:'GPT_WEB_KEYPOSE_SOURCE',authoredPoseCadenceFps:10}])),
  assets:{},projectiles:{primary:{assetId:'TRIAD-SD-CHAR-011',path:'assets/characters/roster/TRIAD-CHAR-011/lobby/sena_lobby_rgba_v3_staff_luma.png',facing:'RIGHT',embeddedInCharacterAtlas:false}},
